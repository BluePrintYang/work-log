...
```json
GET /v9/content/fresh/detail?freshId=FRESH_66a1fbb9-8170-4764-ad82-edcff7e6016e&oick=1cbddfd8 HTTP/1.1
```

#### 文章详情

```json
GET /v7/api/growth/info/getGrowthInfo?id=FRESH_a8804876-7832-4813-b374-486b9e2ed8f3&oick=1cbddfd8 HTTP/1.1
```
